$(function(){
 // filebox 클래스를 가진 요소들의 개수를 세기
var fileboxCount = $(".file-list .filebox").length;	
var fileNo = fileboxCount;
var filesArr = new Array();
var fileArrLength = filesArr.length;
	fileArrLength += fileboxCount;
var count = fileboxCount;
$('#photo_count').val(count);
$('#count').text(fileArrLength + "/4");
...
/* 첨부파일 추가 */
  $('#upload').change(function(){
   ...
   if(this.files.length==1){
	...
	입력 글자수 보여주기
	------------------*/
	let inputLength = $('#product_title').val().length;
	...
	let remain2 = textLength;
		remain2 += '/300';
	$('#content_count').text(remain2);
