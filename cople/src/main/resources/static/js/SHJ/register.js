...
function send_letter(user_id) {
    ...
    // 팝업 창 열기
    var popupWindow = window.open("send_letter?user_id="+user_id, "쪽지 보내기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top + ",scrollbars=yes");
...
function answer_letter(user_id) {
    var width = '600';
    var height = '430';
    ...
    // 팝업 창 열기
    var popupWindow = window.open("answer_letter?user_id="+user_id, "쪽지 보내기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top + ",scrollbars=yes");
...
function send_advice(user_id) {
    ...
    // 팝업 창 열기
    var popupWindow = window.open("send_advice?user_id="+user_id, "첨삭 요청하기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top + ",scrollbars=yes");
...
function answer_advice(user_id) {
    var width = '600';
    var height = '430';
    ...
    // 팝업 창 열기
    var popupWindow = window.open("answer_advice?user_id="+user_id, "쪽지 보내기", "width=" + width + ",height=" + height + ",left=" + left + ",top=" + top + ",scrollbars=yes");
