...
<div class="page-main">
	...
	<form:form action="registerUser" id="member_register"
		...
		<ul>
			...
			<li>
				<form:label path="push">알림수신여부</form:label>
				<input type="radio" name="push" value="Y">예
				<input type="radio" name="push" value="N">아니오
			</li>
			<li>
				<form:label path="certify_photo_name">파일업로드</form:label>
				<input type="file" name="certify_photo_name" id="certify_photo_name">
			</li>
