...
<body>
    <div class="page-main">
        ...
        <div>
			<a class="answer" href="#" onclick="answer_letter('${receiver}')" data-id="${sender}">쪽지 보내기</a>
            ...
            <input type="button" value="목록" onclick="location.href='${pageContext.request.contextPath}/myPage/myLetterSent'">
        </div>
    </div>
</body>
</html>