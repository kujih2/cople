...
<!-- 내용시작 -->
<form:form action="update" modelAttribute="wikiVO" id="update_form" enctype="multipart/form-data">
<form:hidden path="doc_num"/>
<form:hidden path="update_num"/>
<form:textarea path="update_content" style="display: none;" id="textarea"/>

<div class="editor-menu"> 
  	<button class="editor-item" id="btn_headings">
		...
		<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
  		...
  		<div id="sub_headings" style="display:none;">
  			<button id="btn_heading1">문단 제목</button>
  			<button id="btn_heading2">1단계 하위문단 제목</button>
  			<button id="btn_heading3">2단계 하위문단 제목</button>
  		</div>
	<button class="editor-item" id="btn_bold">
	...
	<button class="editor-item" id="btn_italic">
	...
	<button class="editor-item" id="btn_underline">
	...
	<button class="editor-item" id="btn_strike">
	   	<svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-type-strikethrough" viewBox="0 0 16 16">
		  <path d="M6.333 5.686c0 .31.083.581.27.814H5.166a2.776 2.776 0 0 1-.099-.76c0-1.627 1.436-2.768 3.48-2.768 1.969 0 3.39 1.175 3.445 2.85h-1.23c-.11-1.08-.964-1.743-2.25-1.743-1.23 0-2.18.602-2.18 1.607zm2.194 7.478c-2.153 0-3.589-1.107-3.705-2.81h1.23c.144 1.06 1.129 1.703 2.544 1.703 1.34 0 2.31-.705 2.31-1.675 0-.827-.547-1.374-1.914-1.675L8.046 8.5H1v-1h14v1h-3.504c.468.437.675.994.675 1.697 0 1.826-1.436 2.967-3.644 2.967z"/>
		</svg>
	</button>
	<button class="editor-item" id="btn_ordered_list">
	...
	<button class="editor-item" id="btn_unordered_list">
	...
	<button class="editor-item" id="btn_links">
		...
		<div id="sub_links">
			<div id="sub_links_menu">
				<div id="sub_links_menu_title1">위키 내부 문서</div>
				<div id="sub_links_menu_title2">외부 URL</div>
				
				<div id="sub_links_menu_item1">
					<div>
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
							  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
						</svg>
						<input type="text" id="internal_search" autocomplete="off">
						<ul id="search_area"></ul>
					</div>
				</div>
								
				<div id="sub_links_menu_item2">
					<div>
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
						  <path fill-rule="evenodd" d="M8.636 3.5a.5.5 0 0 0-.5-.5H1.5A1.5 1.5 0 0 0 0 4.5v10A1.5 1.5 0 0 0 1.5 16h10a1.5 1.5 0 0 0 1.5-1.5V7.864a.5.5 0 0 0-1 0V14.5a.5.5 0 0 1-.5.5h-10a.5.5 0 0 1-.5-.5v-10a.5.5 0 0 1 .5-.5h6.636a.5.5 0 0 0 .5-.5z"/>
						  <path fill-rule="evenodd" d="M16 .5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0v-5z"/>
						</svg>
						<input type="text" id="external_import" autocomplete="off">
						<button id="btn_linkImport">완료</button>
					</div>
				</div>
			</div>		
		</div>
	...
	<button class="editor-item" id="btn_alignLeft">
	...
	<button class="editor-item" id="btn_alignCenter">
	...
	<button class="editor-item" id="btn_alignRight">
