	...
	<h2>${wiki.doc_name}</h2>
		...
		<div>
			...
			<c:if test="${wiki.update_status==1}">
				<c:if test="${wiki.doc_status==2}">
					<button id="delete_btn" onclick="location.href='delete?doc_num=${wiki.doc_num}&update_num=${wiki.update_num}'">
				...
				<button id="edit_btn" onclick="location.href='update?doc_num=${wiki.doc_num}&update_num=${wiki.update_num}'">
